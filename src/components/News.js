...
export default class News extends Component {
  ...
  async updateNews() {
    ...
    let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=57d8894d4edd444c95cbbd3a1955230e&page=${this.state.page}&pageSize=${this.props.pageSize}`;
